...
public class SecurityConfig {
    ...
    String[] excludeURI = new String[] {"/photocard/api/v1/login", "/photocard/api/v1/member","/photocard/api/v1/duplication-check/user-id/**" ,"/photocard/api/v1/**", "/photocard/api/v1/*/**", "/error"};
    // 비밀번호 암호화
    @Bean
